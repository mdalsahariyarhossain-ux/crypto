  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <p className="text-sm text-slate-400">
        Run decryption 30 times using RSA and ECC (ECIES) private keys to
        evaluate performance consistency and calculate accurate averages.
      </p>
        ...
        <div className="space-y-4">
          ...
          <div className="relative h-72 bg-gradient-to-b from-slate-900 to-slate-900/60 border border-slate-800/80 rounded-2xl p-4 overflow-hidden">
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                <defs>
                  <linearGradient id="rsaGradientDec" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#67e8f9" />
                    <stop offset="100%" stopColor="#0891b2" />
                  </linearGradient>
                  <linearGradient id="eccGradientDec" x1="0" y1="0" x2="0" y2="1">
